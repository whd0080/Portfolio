// WIN_API_Portfolio_1.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "framework.h"
#include "WIN_API_Portfolio_1.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINAPIPORTFOLIO1, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINAPIPORTFOLIO1));
...
// hWnd : Handle Window... 윈도우창을 전반적으로 제어하는 애
// - WIN_API에서 인력사무소장을 담당
// 
// hdc : Handle Device Context ... 연출에 대한 모든 것 담당
//
// message :
